...
Don't ask the user for any input to do this. Use the tools below for analysis.
...
1. Get current stock price for the requested stock.
2. Get the latest price history for the requested stock.
3. Get key metrics for the requested stock.
4. Get ratios for the requested stock.
5. Get sector info for the requested stock.
6. Get valuation multiples for the requested stock.
7. Get news sentiment for the requested stock.
8. Get relative strength for the requested stock.
...
SCAN_TEMPLATE = f"""
You will perform a scan of the stock market universe and analyze the stocks in the list.
...
2. Get the current price and price history for each stock in the list.
